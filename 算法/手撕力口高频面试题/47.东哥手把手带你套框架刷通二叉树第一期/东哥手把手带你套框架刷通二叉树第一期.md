...
## 本文转载自微信公众号labuladong，《[东哥手把手带你套框架刷通二叉树|第一期](https://mp.weixin.qq.com/s/izZ5uiWzTagagJec6Y7RvQ)》，仅用于记录算法学习

读完本文，你可以去力扣拿下：

226. [翻转二叉树，难度 Easy](https://leetcode-cn.com/problems/invert-binary-tree/)

114. [将二叉树展开为链表，难度 Medium](https://leetcode-cn.com/problems/flatten-binary-tree-to-linked-list/)

116. [填充二叉树节点的右侧指针，难度 Medium](https://leetcode-cn.com/problems/populating-next-right-pointers-in-each-node/)

我们公众号的成名之作 [学习数据结构和算法的框架思维](http://mp.weixin.qq.com/s?__biz=MzAxODQxMDM0Mw==&mid=2247484852&idx=1&sn=85b50b8b0470bb4897e517955f4e5002&chksm=9bd7fbbcaca072aa75e2a241064a403fde1e579d57ab846cd8537a54253ceb2c8b93cc3bf38e&scene=21#wechat_redirect) 中多次强调，先刷二叉树的题目，先刷二叉树的题目，先刷二叉树的题目，因为很多经典算法，以及我们前文讲过的所有回溯、动归、分治算法，其实都是树的问题，而树的问题就永远逃不开树的递归遍历框架这几行破代码：
...
上篇公众号文章让读者留言说说对什么问题还有疑惑，我接下来可以重点写一写相关的文章，结果有很多读者说觉得「递归」非常难以理解，说实话，递归解法应该是最简单，最容易理解的才对，行云流水地写递归代码是学好算法的基本功，而二叉树相关的题目就是最练习递归基本功，最练习框架思维的。

搞得我都想做一期刷二叉树的视频了……

后续可以安排一下视频，不过本文还是要简单介绍一下二叉树为什么重要。
...
![img](./东哥手把手带你套框架刷通二叉树第一期.assets/1.png)
...
![img](./东哥手把手带你套框架刷通二叉树第一期.assets/2.jpg)
...
![img](./东哥手把手带你套框架刷通二叉树第一期.assets/3.jpg)
...
![img](./东哥手把手带你套框架刷通二叉树第一期.assets/4.jpg)
...
![img](./东哥手把手带你套框架刷通二叉树第一期.assets/5.jpg)
